...
Detailed notes
Compositional Planning with Jumpy World Models note
H-WM note
Act, Sense, Act note — on-demand read; useful active-perception systems paper with explicit memory and branching-aware framing
Related work: explicit structure in world models and planning
