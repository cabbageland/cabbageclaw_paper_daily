Welcome to the Cabbageland Paper Daily reading notes on OmniVTA: Visuo-Tactile World Modeling for Contact-Rich Robotic Manipulation.

It is one of the cleaner recent cases where a predictive multimodal model is tied directly to a real control interface instead of being bolted on as branding.
